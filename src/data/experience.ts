...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      "Built automation frameworks that reduced manual testing by 75%",
      "Engineered CI/CD pipelines cutting deployment cycles from 2 weeks to 3 days",
      "Developed API testing systems validating 200+ endpoints across multiple applications",
    ],
  },
  {
